...
import static com.nikhilpanju.recyclerviewsample.R.id.rowButton;
...
public class MainActivity extends AppCompatActivity implements RecyclerTouchListener.RecyclerTouchListenerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onTouchListener
                .setIndependentViews(rowButton)
                .setViewsToFade(rowButton)
        ...
        onTouchListener.setUnSwipeableRows(0);
    }
    ...
    private class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
        ...
        public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(MainActivity.this,"onCreateViewHolder",Toast.LENGTH_LONG).show();
                }
            });
