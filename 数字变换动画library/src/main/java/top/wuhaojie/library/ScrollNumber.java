...
public class ScrollNumber extends View {
    ...
    private long mDeltaNum;
    private long mCurNum;
    private long mNextNum;
...
//        setNumber(0, 6, 1000);
    ...
    public void setNumber(final long from, final long to, long delay) {
...
//        canvas.restore();
    ...
    private void setFromNumber(long number) {
    ...
    private void calNum(long number) {
    ...
    public void setTargetNumber(long nextNum) {
